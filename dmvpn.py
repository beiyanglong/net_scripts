...
target.write("ip route 158.106.88.130 255.255.255.255 "+Default_Gateway_IP+" name BACKDOOR_MGMT_1"+"\n")
target.write("ip route 207.164.20.51 255.255.255.255 "+Default_Gateway_IP+" name BACKDOOR_MGMT_2"+"\n")
...
target.write(" ip address "+Tunnel0_IP+" 255.255.252.0"+"\n")
